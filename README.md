...
Check the [releases](https://github.com/droboports/e2fsprogs/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/e2fsprogs.git
cd e2fsprogs
./build.sh
ls -la *.tgz
```
...
* e2fsprogs: http://sourceforge.net/projects/e2fsprogs/
